...
function SlotBooking() {
  const handleSubmit=(e)=>{
   ...
   const DisplaySecond = () => {
    return (
      <>
      <p className={bookmyitemsstyles.confirmedup}>Booking confirmed</p>
      <p className={bookmyitemsstyles.confirmeddown}>Your booking confirmation has been sent to your email.</p>
      </>
    )
  }
  ...
  return (
    <div className={bookmyitemsstyles.fullcontainer}>
      ...
      <div className={bookmyitemsstyles.rightcontainer}>
         {display}
      </div>
    </div>
  )
